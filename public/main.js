(() => {
      ...
      9 === t.keyCode &&
        (t.shiftKey && document.activeElement === this.firstFocusable
          ...
          : t.shiftKey ||
            ...
            (t.preventDefault(), this.firstFocusable.focus()));
    }
  }
  class s {
    constructor() {
    ...
    disable() {
      (this.isActive = !1),
        ...
        this.animations.forEach((t) => {
          t.renderer &&
            t.renderer.gl.clear(
              t.renderer.gl.COLOR_BUFFER_BIT | t.renderer.gl.DEPTH_BUFFER_BIT
            ),
  ...
  (c.Renderer = class {
    ...
    resize() {
      ...
      return (
        !(
          this.gl.canvas.width * this.pixelRatio === t &&
          this.gl.canvas.height * this.pixelRatio === e
        ) &&
    ...
    render(t, e) {
      ...
      for (const o of t.objects) {
        ...
        if (
          (o.shader.program !== s &&
            (this.gl.useProgram(o.shader.program),
            (s = o.shader.program),
            (t = !0)),
          t || o.attributes != i)
        ) {
          ...
          if ("uViewProjectionMatrix" === t)
            ...
            switch (o.uniforms[t].type) {
              ...
              case "2f":
                this.gl.uniform2f(
                  o.uniforms[t].location,
                  o.uniforms[t].value[0],
                  o.uniforms[t].value[1]
                );
                break;
              case "3f":
                this.gl.uniform3f(
              ...
              case "tex":
                this.gl.uniform1i(
                  o.uniforms[t].location,
                  o.uniforms[t].value.id
                ),
                  this.gl.activeTexture(
                    this.gl.TEXTURE0 + o.uniforms[t].value.id
                  ),
                  this.gl.bindTexture(
                    this.gl.TEXTURE_2D,
                    o.uniforms[t].value.texture
                  );
            }
    ...
    (c.Orthographic = class {
      ...
      setViewProjectionMatrix() {
        this._recalculateViewMatrix(),
          (this.viewProjectionMatrix = o.multiply(
            this.matrix,
            this.viewMatrix
          ));
      }
    ...
    (c.Mesh = class {
      ...
      _setSurfaceNormals() {
        if (this.surfaceNormals) {
          ...
          for (
            ...
            const s = [
                this.geometry.attributes.aNormal.data[e],
                this.geometry.attributes.aNormal.data[e + 1],
                this.geometry.attributes.aNormal.data[e + 2],
              ],
              o = [
                this.geometry.attributes.aNormal.data[e + 3],
                this.geometry.attributes.aNormal.data[e + 4],
                this.geometry.attributes.aNormal.data[e + 5],
              ],
              n = [
                this.geometry.attributes.aNormal.data[e + 6],
                this.geometry.attributes.aNormal.data[e + 7],
                this.geometry.attributes.aNormal.data[e + 8],
              ],
              r = i.subtract(o, s),
              a = i.subtract(n, s),
              h = r[1] * a[2] - r[2] * a[1],
      ...
      _recalculateModelMatrix() {
        ...
        (a = o.multiply(a, s)),
          ...
          this.parentCollection
            ? (this.localMatrix = o.multiply(
                this.parentCollection.localMatrix,
                a
              ))
            : (this.localMatrix = a);
      }
      ...
      setUniform(t, e, s) {
        (this.uniforms[t] = { name: t, value: e, type: s }),
          this._setUniformData();
      }
      setShader(t) {
    ...
    (c.Sphere = class extends r {
      constructor(t, e) {
        ...
        for (let t = 0; t < this.attributes.aNormal.data.length; t += 3) {
          let e = 0;
          -1 == this.attributes.aNormal.data[t + 1] &&
          this.attributes.aNormal.data[t] >= 0
            ? (e = -0.5)
            : -1 == this.attributes.aNormal.data[t + 1] &&
              this.attributes.aNormal.data[t] < 0 &&
              (e = 0.5);
          const s =
              0.5 +
              Math.atan2(
                this.attributes.aNormal.data[t],
                this.attributes.aNormal.data[t + 2]
              ) /
                (2 * Math.PI),
      ...
      constructor(t, e) {
        (this.type = t),
          "directional" === this.type
            ? (this.direction = i.normalize([e[0], e[1], e[2]]))
            : "point" === this.type && (this.position = [e[0], e[1], e[2]]);
      }
      setDirection(t, e, s) {
  ...
  class l {
    ...
    static _easeOutSpring(t) {
      ...
      return (
        1 * Math.pow(2, -10 * t) * Math.sin(((t - e) * (2 * Math.PI)) / 0.3) + 1
      );
    }
    ...
    update(t) {
      "class" !== this.property
        ? (this.target[this.property] =
            this.propertyDelta.start +
            t * this.propertyDelta.delta +
            this.units)
        : (0 === t &&
  ...
  class p {
    ...
    _getTransformPercentage(t, e) {
      return "translateX" === t
        ? e * (this.bounds.width / 100)
        : e * (this.bounds.height / 100);
    }
    setProperties() {
        ...
        for (const e in this.properties)
          if (this.transformPropertyKeys.includes(e))
            if (((this.hasTransform = !0), "scale" === e))
              ...
              "fromTo" === this.direction
                ...
                : this.actions.push(
                    new d(
                      ...
                      e,
                      this.properties[e],
                      parseFloat(this.transformMatrix[e]),
                      null,
                      this.direction
                    )
                  );
              ...
              this.actions.push(
                new d(this.transformMatrix, e, t, s, null, this.direction)
              );
            } else {
    ...
    update(t) {
      ...
      if (this.hasTransform) {
        const t = u.multiply2DMatricies(
          u.multiply2DMatricies(
            u.scale2D(this.transformMatrix.scaleX, this.transformMatrix.scaleY),
            u.rotate2D(this.transformMatrix.rotate * (Math.PI / 180))
          ),
          u.translate2D(
  ...
  class m {
    static to(t, e, s) {
      ...
      (t instanceof window.HTMLElement || t instanceof window.NodeList) &&
        ((i = !0), t instanceof window.NodeList && (o = [...t]));
    ...
    static _setTimings(t, e) {
      const s = 1e3,
        i = {};
      return (
        (i.duration = e.duration ? e.duration * s : 1),
          ...
          (t.progress =
            ...
            t.started &&
              ...
              t.moments.forEach((e, s) => {
                const i = Math.max(
                    this.currentTime - t.timings.start - t.timings.stagger * s,
                    0
                  ),
        ...
        (this.observer = null),
          ...
          this.options.pinned
            ? ((this.offset = this.element.parentElement.offsetTop),
              ...
              (this.scrollHeight += this.options.offset
                ? this.options.offset
                : 0))
            : ((this.offset =
                window.pageYOffset +
  ...
  class x {
    ...
    onResize(t) {
      ...
      const e = this.createGridGeometry(
    ...
    draw() {
      ...
      for (var e = 0; e < this.iterations.count; e++)
        if (this.iterations.objects[e]) {
          ...
          this.ctx.beginPath(),
            this.ctx.arc(
              s + (this.progress.scale - 1) * (s - t),
              this.canvas.height / this.progress.scale / 2,
              this.iterations.radius,
              0,
              2 * Math.PI,
              !0
            ),
  ...
  class S {
    ...
    draw() {
      ...
      for (let t = 0; t < this.balloons.length; t++)
        (this.balloons[t].y -=
          ...
          this.balloons[t].velocity *
          this.scaleFactor),
          this.balloons[t].y < -130 * this.scaleFactor
            ? ((this.balloons[t].x =
                Math.random() * (this.viewport.width - 75 * this.scaleFactor)),
              (this.balloons[t].y = this.viewport.height))
            : this.drawBalloon(this.balloons[t]);
    ...
    drawBalloon(t) {
      ...
      this.ctx.isPointInPath(e, this.mouse.xOffset, this.mouse.yOffset) &&
      !t.isPopped
    ...
    reticleLines(t, e) {
      (this.ctx.strokeStyle = "#D66761"),
        ...
        this.ctx.lineTo(
          t,
          (e + 60) * (1 - this.progress.triggerFlash) +
    ...
    reticleImpact(t, e) {
      ...
      this.progress.impact > 0 &&
        (this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(s) * (72 - 24 * this.progress.impact),
          e + Math.sin(s) * (72 - 24 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(2 * s) * (60 - 12 * this.progress.impact),
          e + Math.sin(2 * s) * (60 - 12 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(3 * s) * (72 - 24 * this.progress.impact),
          e + Math.sin(3 * s) * (72 - 24 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(5 * s) * (60 - 12 * this.progress.impact),
          e + Math.sin(5 * s) * (60 - 12 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(6 * s) * (96 - 48 * this.progress.impact),
          e + Math.sin(6 * s) * (96 - 48 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(7 * s) * (60 - 12 * this.progress.impact),
          e + Math.sin(7 * s) * (60 - 12 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(9 * s) * (72 - 24 * this.progress.impact),
          e + Math.sin(9 * s) * (72 - 24 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(10 * s) * (60 - 12 * this.progress.impact),
          e + Math.sin(10 * s) * (60 - 12 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(11 * s) * (72 - 24 * this.progress.impact),
          e + Math.sin(11 * s) * (72 - 24 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(13 * s) * (60 - 12 * this.progress.impact),
          e + Math.sin(13 * s) * (60 - 12 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(14 * s) * (96 - 48 * this.progress.impact),
          e + Math.sin(14 * s) * (96 - 48 * this.progress.impact)
        ),
        ...
        this.ctx.beginPath(),
        this.ctx.moveTo(
          t + Math.cos(15 * s) * (60 - 12 * this.progress.impact),
          e + Math.sin(15 * s) * (60 - 12 * this.progress.impact)
        ),
    ...
    onMouseDown(t) {
      ...
      e
        ? ((this.mouse.x = e[0].clientX), (this.mouse.y = e[0].clientY))
  ...
  class z {
    constructor() {
      (this.accessible = new O()),
        ...
        (this.visionInnerPath = document.querySelector(
          "section.accessible #vision-icon circle"
        )),
        (this.hearingOuterPath = document.getElementById(
          "hearing-icon--outer"
        )),
        (this.hearingInnerPath = document.getElementById(
          "hearing-icon--inner"
        )),
        (this.hearingSquigglePath = document.getElementById(
          "hearing-icon--squiggle"
        )),
        (this.motorWaves = document.querySelectorAll(
          "section.accessible #motor-icon .wave"
        )),
        (this.visionWaves = document.querySelectorAll(
          "section.accessible #vision-icon .wave"
        )),
        (this.hearingWaves = document.querySelectorAll(
          "section.accessible #hearing-icon .wave"
        ));
    }
    onScroll(t) {
      const e = this.accessible.metrics.scrollY - this.viewport.height;
      t.y >= e + this.metrics.motorOffset &&
        (this.motorPathHasRun ||
          (this.motorScene.play(), (this.motorPathHasRun = !0))),
        t.y >= e + this.metrics.visionOffset &&
          (this.visionPathHasRun ||
            (this.visionScene.play(), (this.visionPathHasRun = !0))),
        t.y >= e + this.metrics.hearingOffset &&
          (this.hearingPathHasRun ||
            (this.hearingScene.play(), (this.hearingPathHasRun = !0)));
    }
    onDestroy() {
    ...
    onResize(t) {
      (this.viewport = t),
        ...
        (this.visionPathHasRun = !1),
        (this.hearingPathHasRun = !1),
        (this.metrics.motorOffset =
          this.motorIcon.parentNode.offsetTop - this.viewport.height / 8),
        (this.metrics.visionOffset =
          this.visionIcon.parentNode.offsetTop - this.viewport.height / 8),
        (this.metrics.hearingOffset =
          this.hearingIcon.parentNode.offsetTop - this.viewport.height / 8),
        ...
        this.visionScene.fromTo(
          this.visionOuterPath,
          { "stroke-dashoffset": [555, 0] },
          { duration: 2.5, ease: "easeInOutQuint" },
          0
        ),
        this.visionScene.fromTo(
          this.visionInnerPath,
        ...
        this.hearingScene.fromTo(
          this.hearingOuterPath,
          { "stroke-dashoffset": [468, 936] },
          { duration: 2, ease: "easeInOutQuint" },
          0
        ),
        this.hearingScene.fromTo(
          this.hearingInnerPath,
          { "stroke-dashoffset": [138, 276] },
          { duration: 2.5, ease: "easeInOutQuint" },
          0
        ),
        this.hearingScene.fromTo(
          this.hearingSquigglePath,
  ...
  class D {
    constructor() {
      (this.dimensions = new U()),
        ...
        (this.background = document.querySelectorAll(
          "section.dimensions .dimensions--gate__inner"
        )),
        (this.gate = document.querySelectorAll(
          "section.dimensions .dimensions--gate"
        ));
    }
    onResize(t) {
      (this.viewport = t),
  ...
  class L {
    ...
    createCube(t) {
      ...
      return (
        b.setPosition(0.1, -0.1, 0), b.setParent(e), this.tesseracts.push(b), e
      );
    }
      ...
      (this.tesseracts = []),
        ...
        this.viewport.aspectRatio > 1
          ? (this.createTesseractInstance({
              x: -0.625 * this.viewport.aspectRatio,
              y: 0.625,
              z: 0,
            }),
          ...
          : (this.createTesseractInstance({
              x: -0.4375 * this.viewport.aspectRatio,
              y: 0.625,
              z: 0,
            }),
            this.createTesseractInstance({
    ...
    onUpdate(t) {
      ...
      for (let t = 0; t < this.tesseractParents.length; t++)
        this.tesseractParents[t].setScale(
          this.progress.reveal2D,
          this.progress.reveal2D,
          this.progress.reveal2D
        ),
          this.tesseractParents[t].setRotationX(
            20 * this.progress.reveal3D - 15 * this.progress.reveal4D
          ),
          this.tesseractParents[t].setRotationY(
            20 * this.progress.reveal3D + 90 * this.progress.reveal4D
          ),
          this.tesseractParents[t].isOuter &&
            this.tesseractParents[t].setScale(
              this.progress.reveal2D + this.progress.reveal4D,
              this.progress.reveal2D + this.progress.reveal4D,
              this.progress.reveal2D + this.progress.reveal4D
            );
      for (let t = 0; t < this.tesseractLines.length; t++)
        this.progress.reveal2D >= 1 && this.progress.reveal3D < 1
          ? ((this.tesseractLines[t].uniforms.uGreenToRed.value = 1),
            (this.tesseractLines[t].uniforms.uRedToBlue.value = 0))
          : this.progress.reveal3D >= 1 && this.progress.reveal4D < 1
          ? ((this.tesseractLines[t].uniforms.uGreenToRed.value = 1),
            (this.tesseractLines[t].uniforms.uRedToBlue.value = 1))
          : ((this.tesseractLines[t].uniforms.uGreenToRed.value = 0),
            (this.tesseractLines[t].uniforms.uRedToBlue.value = 0)),
          this.tesseractLines[t].setPosition(
            this.tesseractLines[t].startPosition.x +
              this.progress.reveal4D *
                this.tesseractLines[t].endPositionDelta.x,
            this.tesseractLines[t].startPosition.y +
              this.progress.reveal4D *
                this.tesseractLines[t].endPositionDelta.y,
            this.tesseractLines[t].startPosition.z +
              this.progress.reveal4D * this.tesseractLines[t].endPositionDelta.z
          ),
          this.tesseractLines[t].setScale(
            this.progress.reveal4D,
            this.progress.reveal4D,
            this.progress.reveal4D
          );
      for (let t = 0; t < this.tesseracts.length; t++)
        this.progress.reveal2D >= 1 && this.progress.reveal3D < 1
          ? ((this.tesseracts[t].uniforms.uGreenToRed.value = 1),
            (this.tesseracts[t].uniforms.uRedToBlue.value = 0))
          : this.progress.reveal3D >= 1 && this.progress.reveal4D < 1
          ? ((this.tesseracts[t].uniforms.uGreenToRed.value = 1),
            (this.tesseracts[t].uniforms.uRedToBlue.value = 1))
          : ((this.tesseracts[t].uniforms.uGreenToRed.value = 0),
            (this.tesseracts[t].uniforms.uRedToBlue.value = 0));
      this.renderer.gl.clearColor(0, 0, 0, 0),
        this.renderer.render(this.volume, this.camera);
    }
  ...
  class C {
    constructor() {
      (this.dimensions = new U()),
        ...
        (this.two = document.querySelector(
          "section.dimensions .dimensions--copy .two"
        )),
        (this.three = document.querySelector(
          "section.dimensions .dimensions--copy .three"
        )),
        (this.four = document.querySelector(
          "section.dimensions .dimensions--copy .four"
        ));
    }
    onResize(t) {
      (this.scene = this.dimensions.scene),
    ...
    onUpdate(t) {
      this.progress.value >= 0 && this.progress.value < 1.25
        ? (this.two.classList.remove("hidden"),
          this.three.classList.add("hidden"),
          this.four.classList.add("hidden"))
        : this.progress.value >= 1.25 && this.progress.value < 1.75
        ? (this.two.classList.add("hidden"),
  ...
  class q {
    constructor() {
      (this.travel = new X()),
        ...
        this.orientation.matches
          ? (this.image.src = "images/travel-1x--portrait.jpg")
          : (this.image.src = "images/travel-1x.jpg"),
      ...
      (this.scene = this.contact.scene),
        ...
        this.scene.fromTo(
          ...
          { opacity: [0, 1] },
          {
            ...
            ease: "easeInOutExpo",
            onComplete: () => {
              (this.played && "0" !== this.splitText[0].style.opacity) ||
  ...
  class Z {
    constructor() {
      (this.viewport = {
        ...
        (this.DOM = document.querySelectorAll(
          "section.work .work--grid .work--item"
        )),
        (this.cards = []);
    ...
    onResize(t) {
      (this.viewport = t),
        this.shouldAnimate
          ? (this.createCardObjects(), this.createScenes())
          : (this.cards = []);
    }
    onScroll(t) {
      this.shouldAnimate
  ...
  new (class {
    ...
    lazyLoad() {
      this.lazyLoadItems.forEach((t) => {
        if (
          !t.loaded &&
          (window.scrollY >= t.scrollTarget ||
            window.pageYOffset >= t.scrollTarget)
        ) {
